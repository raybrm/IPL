...
import DecoratorPattern.RobotAmerliorationBouclier;
import DecoratorPattern.RobotAmerliorationCanon;
...
public class PatternRobots {
	...
	public static void main(String[] args) {
		Robot robot1= new RobotAmerliorationCanon(new RobotImpl.RobotBuilder("robot1").puissanceCanon(10).puissanceBouclier(2).build());// un robot avec un canon de 10, un bouclier de 2, une fréquence de tir de 100 et qui a reçu une amélioration de canon multipliant la puissance de ce dernier par 2.
		Robot robot2= new RobotAmerliorationBouclier(new RobotImpl.RobotBuilder("robot2").puissanceCanon(9).puissanceBouclier(3).frequenceTir(90).build());// un robot avec un canon de 9, un bouclier de 3, une fréquence de tir de 90 
